...
$tinybrowser['path']['image'] = '/imagens_site/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/imagens_site/'; // Media files location
$tinybrowser['path']['file']  = '/imagens_site/'; // Other files location
